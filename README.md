...
présence Défense avérée ;

importance industrielle en France ;

position dans la chaîne de valeur ;

participation à des programmes structurants ;
...
distinguer clairement donnée publiée et donnée calculée ;

conserver le périmètre exact d'un indicateur financier ;

ne pas attribuer une donnée groupe à un établissement ;

ne pas associer un site à un programme sans preuve documentaire ;

distinguer statut administratif et activité BITD documentée ;

conserver la provenance des informations importantes ;

rendre la sélection des entreprises elle-même explicable ;

signaler les limites et approximations du référentiel ;

préférer une donnée absente à une donnée faussement précise.
